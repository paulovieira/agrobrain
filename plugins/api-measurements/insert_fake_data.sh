...
curl -v -L -G -d 'mac=999-888-777&data[0][sid]=1234&data[0][value]=10.1&data[0][type]=t&data[0][desc]=microfone_1&battery=294.12' http://$1:8001/api/v1/readings;
sleep 1;

curl -v -L -G -d 'mac=999-888-777&data[0][sid]=1234&data[0][value]=20.1&data[0][type]=t&data[0][desc]=microfone_1&battery=293.12' http://$1:8001/api/v1/readings;
sleep 1;

curl -v -L -G -d 'mac=999-888-777&data[0][sid]=1234&data[0][value]=80.1&data[0][type]=h&data[0][desc]=microfone_1&battery=292.12' http://$1:8001/api/v1/readings;
sleep 1;

curl -v -L -G -d 'mac=999-888-777&data[0][sid]=1234&data[0][value]=3000&data[0][type]=h&data[0][desc]=microfone_1&battery=290.12' http://$1:8001/api/v1/readings;
sleep 1;
